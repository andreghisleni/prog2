/**
  4) Construa um programa em C que cumpra os seguintes requisitos:
    ...
    Após finalizar a leitura da matriz, salve os pontos da diagonal principal da matriz em uma lista duplamente encadeada;
    Implemente uma subrotina que receba a lista duplamente encadeada como parâmetro e retorne uma struct com: a soma dos valores de x e a multiplicação dos valores de y dos pontos tridimensionais armazenados na lista encadeada;  
    Antes de encerrar, o programa principal deve imprimir os pontos da matriz, os pontos da lista duplamente encadeada e os campos da struct que retornou da subrotina com os cálculos;
...
// Função para calcular a soma dos valores de x e a multiplicação dos valores de y dos pontos na lista
...
int main() {
    ...
    // Exibir pontos da lista duplamente encadeada
    printf("\nPontos na lista duplamente encadeada (diagonal principal):\n");
    ...
    // Liberar a memória alocada para a lista duplamente encadeada
